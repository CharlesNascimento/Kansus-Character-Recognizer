...
public class MLP {
	...
	private int numeroMaximoCiclos = 5000;
	...
	public MLP() {
		...
		this.camadaIntermediaria = new CamadaIntermediaria("C1", 256, this.camadaEntrada.getNumeroNeuronios());
		this.camadaSaida = new CamadaSaida("C2", 94, this.camadaIntermediaria.getNumeroNeuronios());
	 ...
	 */
	public void treinar(ProgressListener progressListener, int progresso) {
